...
export const WxLoadingRoute: AppRouteRecordRaw = {
  path: '/wx-loading',
  name: 'wx-loading',
  component: () => import('/@/views/system/loginmini/wx-loading.vue'),
  meta: {
    title: '微信登录',
    ignoreAuth: true,
  },
...
export const basicRoutes = [LoginRoute, RootRoute, ...mainOutRoutes, REDIRECT_ROUTE, PAGE_NOT_FOUND_ROUTE, TokenLoginRoute, Oauth2LoginRoute,WxLoadingRoute];
