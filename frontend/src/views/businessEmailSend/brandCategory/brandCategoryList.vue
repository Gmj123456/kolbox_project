<template>
  <a-card :bordered="false">
      ...
      <a-row :gutter="12">
        <a-col :xl="4" :lg="7" :md="8" :sm="24">
          <a-form-item>
            <a-input
              placeholder="品牌类目"
              v-model:value.trim="queryParam.categoryName"
            ></a-input>
          </a-form-item>
        </a-col>
    ...
    <div>
      ...
      <BrandCategoryModal ref="modalFormRef" @ok="modalFormOk" />
    </div>
  </a-card>
</template>
...
import BrandCategoryModal from './modules/brandCategoryModal.vue';
