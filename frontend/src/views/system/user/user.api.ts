...
enum Api {
  ...
  batchSetEmployee='/sys/user/batchSetEmployee',
}
/**
 * 导出api
 * @param params
 ...
 * @param params
 */
export const batchSetEmployeeApi = (params) => {
  return defHttp.get({ url: Api.batchSetEmployee, params },{isTransformResponse:false});
};