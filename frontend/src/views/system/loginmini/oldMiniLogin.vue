      ...
      <div class="aui-content">
        <div class="aui-container">
          <div class="aui-form">
            ...
            <div class="aui-formBox login-form-box" >
              <div class="aui-formWell">
                ...
                <h3 style="font-size: 18px;font-weight: 600;margin-bottom: 20px;color: rgb(43, 43, 43);">
                  欢迎登录!
                </h3>
                  ...
                  <a-form ref="loginRef" :model="formData" v-if="activeIndex === 'accountLogin'" @keyup.enter.native="loginHandleClick">
                    <div class="aui-account">
                      <div class="aui-inputClear">
                       <!-- <div style="width:60px;color:#fff;background-color:#3155ed ;"> <i class="icon icon-code"></i></div> -->
                        <a-form-item>
                      ...
                      <div class="aui-inputClear" style="background-color: transparent;display: flex;justify-content: space-between;align-items: center;">
...
<style lang="less" >
  .login-form-box .aui-form-box .ant-input-group .ant-input-group-addon{
    ...
    .login-form-box .aui-form-box .ant-input-group .ant-input {
    border:none;
    height: 40px;
  ...
  /* 修复浏览器自动填充时的背景色覆盖问题 */
  .login-form-box .aui-form-box .ant-input-group .ant-input:-webkit-autofill,
  .login-form-box .aui-form-box .ant-input-group .ant-input:-webkit-autofill:hover,
  .login-form-box .aui-form-box .ant-input-group .ant-input:-webkit-autofill:focus,
  .login-form-box .aui-form-box .ant-input-group .ant-input:-webkit-autofill:active {
...
html[data-theme='dark'] {
  .@{prefix-cls} {
    ...
    .ant-input-password:-webkit-autofill:active {
      -webkit-box-shadow: 0 0 0 30px #232a3b inset !important;
  ...
  /* 修复浏览器自动填充时的背景色覆盖问题 */
  input.fix-auto-fill:-webkit-autofill,
  input.fix-auto-fill:-webkit-autofill:hover,
  input.fix-auto-fill:-webkit-autofill:focus,
  input.fix-auto-fill:-webkit-autofill:active,
  .fix-auto-fill input:-webkit-autofill,
  .fix-auto-fill input:-webkit-autofill:hover,
  .fix-auto-fill input:-webkit-autofill:focus,
  .fix-auto-fill input:-webkit-autofill:active {
    -webkit-box-shadow: 0 0 0 30px #f4f4f4 inset !important;
    -webkit-text-fill-color: #333 !important;
    transition: background-color 5000s ease-in-out 0s;
  }
