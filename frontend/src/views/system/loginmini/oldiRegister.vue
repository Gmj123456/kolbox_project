        ...
        <div class="aui-formBox">
          <div class="aui-formWell">
            <a-form ref="formRef" :model="formData">
              <div class="aui-flex aui-form-nav investment_title" style="justify-content: flex-end;padding-bottom: 0px;">
                  <img style="height: 60px;" src="@/assets/images/slogo.png" alt="">
                </div>
              <div class="aui-form-box">
                <div class="aui-account aui-account-line" style="padding-bottom: 0px;">
                  <a-form-item>
                    <div class="aui-input-line">
                      <!-- <Icon class="aui-icon" icon="ant-design:user-outlined"/> -->
                      <a-input style="padding-left: 10px;" class="fix-auto-fill" type="text" :placeholder="t('sys.login.userName')" v-model:value="formData.username" />
                    </div>
                  </a-form-item>
                  <!-- <a-form-item>
                    <div class="aui-input-line">
                      <Icon class="aui-icon" icon="ant-design:mobile-outlined"/>
                      <a-input style="padding-left: 10px;" class="fix-auto-fill" type="text" :placeholder="t('sys.login.mobile')" v-model:value="formData.mobile" />
                    </div>
                  </a-form-item>
                  <a-form-item>
                    <div class="aui-input-line">
                  ...
                  <a-form-item>
                    <div class="aui-input-line">
                      ...
                      <a-input style="padding-left: 10px;" class="fix-auto-fill" :type="pwdIndex==='close'?'password':'text'" :placeholder="t('sys.login.password')" v-model:value="formData.password" />
                      <div class="aui-eye">
                  ...
                  <a-form-item>
                    <div class="aui-input-line">
                      <!-- <Icon class="aui-icon" icon="ant-design:lock-outlined"/> -->
                      <a-input style="padding-left: 10px;" class="fix-auto-fill" :type="confirmPwdIndex==='close'?'password':'text'" :placeholder="t('sys.login.confirmPassword')" v-model:value="formData.confirmPassword" />
                      <div class="aui-eye">
                  ...
                  <a-form-item>
                    <div class="aui-input-line mobile-input-line">
                      <!-- <Icon class="aui-icon" icon="ant-design:lock-outlined"/> -->
                      <a-input  lass="fix-auto-fill"  placeholder="手机号" v-model:value="formData.mobile">
                  ...
                  <!-- <a-form-item>
                    <div class="aui-input-line">
                      ...
                      <a-input style="padding-left: 10px;" class="fix-auto-fill"  placeholder="请输入上级邀请码(选填)" v-model:value="formData.parentInvitationCode" />
                  ...
                  <a-form-item>
                    <div class="aui-input-line">
                      <!-- <Icon class="aui-icon" icon="ant-design:lock-outlined"/> -->
                      <a-input style="padding-left: 10px;" class="fix-auto-fill"  placeholder="邮箱" v-model:value="formData.email" />
                  ...
                  <a-form-item>
                    <div style="display: flex;align-items: center;gap: 10px;">
                      ...
                      <div style="width: 70%;" class="aui-input-line">
                        <!-- <Icon class="aui-icon" icon="ant-design:lock-outlined"/> -->
                        <a-input style="padding-left: 10px;" lass="fix-auto-fill"  placeholder="邮箱验证码" v-model:value="formData.captcha">
                        ...
                        <a-button 
                          ...
                          style="padding: 22px 35px;display: flex;align-items: center;"
                        >
...
<script lang="ts" setup name="mini-register">
  import { ref, reactive, unref, toRaw, onBeforeUnmount } from 'vue';
...
import { defHttp } from '/@/utils/http/axios';
  ...
  function getCaptcha(){
    ...
    defHttp.post({ url: '/sys/getEmailCode', params: { username: formData.username, email: formData.email,smsmode: '1' } },{isTransformResponse: false}).then((res) =>{
      if(res.success){
  ...
  function registerHandleClick() {
    ...
    // 校验手机号格式（以1开头，第二位3-9，后面9位0-9数字）
    const mobilePattern = /^1[3-9]\d{9}$/;
    if (!mobilePattern.test(formData.mobile)) {
      createMessage.warn('请输入正确的手机号');
      return;
    }
    if (!formData.email) {
      createMessage.warn('请输入邮箱');
...
.mobile-input-line :deep(.ant-input){
