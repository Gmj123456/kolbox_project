...
const initEmailDateData = () => {
  ...
  defHttp.post({ url: "/email/emailPushDetail/dailyTrend", data: params }).then((res) => {
    console.log(res);
    if (res) {
...
const initAllEmailData = () => {
  ...
  defHttp.post({ url: "/email/emailPushDetail/summary", data: params }).then((res) => {
    console.log(res);
    if (res) {
...
const initAllCounselorEmailData = () => {
  ...
  console.log(params);
  defHttp.post({ url: "/email/emailPushDetail/counselorTop", data: params })
    .then((res) => {
      console.log(res);
      if (res) {
