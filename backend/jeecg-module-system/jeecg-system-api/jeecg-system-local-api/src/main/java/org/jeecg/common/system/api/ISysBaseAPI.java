...
public interface ISysBaseAPI extends CommonAPI {
    ...
    List<LoginUser> getUserByIds(List<String> counselorIds);

    void updatePromotionBrand(List<String> productIds,String brandId, String brandName);
    List<PersonalTagsModel> getPersonalTagsCategory();
    /**
     * 功能描述：根据商务顾问名称获取用户信息
     *
     * @param celebrityCounselorName
     * @Param:
     * @Author: fengLiu
     * @Date: 2023/10/21 14:08
     */
    LoginUser getCelebrityCounselor(String celebrityCounselorName);
    List<LoginUser> getBusinessUserList();

    StoreUserContactEmailVo getContactEmailById(String contactEmailId);
    List<StoreUserContactEmailVo> getContactEmailByUserId(String userId);
}
