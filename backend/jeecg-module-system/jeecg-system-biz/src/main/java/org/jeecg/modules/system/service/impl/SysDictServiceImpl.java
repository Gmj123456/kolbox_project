...
//	}
	...
	@Override
	public String queryDictValueByText(String code, String itemText) {
		return sysDictMapper.queryDictValueByText(code, itemText);
	}
	@Override
	public List<SysDictItem> getItemList(String code) {
		return sysDictMapper.getItemList(code);
	}
	/**
	 * 根据dict_code查询字典列表
	 * */
	@Override
	public List<SysDictItem> queryItemByDictCode(@Param("dictCode") String dictCode){
		return sysDictMapper.queryItemByDictCode(dictCode);
	}

	@Override
	public List<DictModel> selectItemListByCode(String code) {
		return sysDictMapper.selectItemListByCode(code);
	}
}
