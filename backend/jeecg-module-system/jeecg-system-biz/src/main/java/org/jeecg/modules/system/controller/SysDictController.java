...
//		redisTemplate.delete(keys7);
	 ...
	 * @return
	 */
	@GetMapping("/queryItemByDictCode")
	public Result<?> queryItemByDictCode(@RequestParam(name="dictCode") String dictCode) {
		return Result.ok(sysDictService.queryItemByDictCode(dictCode));
	}
}
