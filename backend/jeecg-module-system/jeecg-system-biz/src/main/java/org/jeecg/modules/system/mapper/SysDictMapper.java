...
public interface SysDictMapper extends BaseMapper<SysDict> {
	...
	public String queryDictValueByText(@Param("code") String code, @Param("itemText") String itemText);

	List<SysDictItem> getItemList(String code);
	/**
	 * 根据dict_code查询字典列表
	 */
	List<SysDictItem> queryItemByDictCode(@Param("dictCode") String dictCode);

	List<DictModel> selectItemListByCode(String code);
}
