...
public interface ISysUserService extends IService<SysUser> {
	...
	JSONObject currentAmountPayTaxMent(SysUser sysUser, BigDecimal payMoney);

	JSONObject currentAmountPayMent(SysUser sysUser, BigDecimal payMoney, String sellerPromotionId, Integer payType, String remark);

	List<SysUser> getCounselorList();
	/**
	 * 添加商家用户
	 *
	 * @param user
	 * @param selectedParts
	 */
    void addSellerUser(SysUser user, String number, String e6606c64fd9643d182fb0a504e2f6e6c, StoreEmailPackagePurchase storeEmailPackagePurchase);
}
