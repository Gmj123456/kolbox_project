...
//	public List<DictModel> queryTableDictItems(String table, String text, String code,String keyword);
	...
	String queryDictValueByText(String promotionPayment, String invoicetax);

	List<SysDictItem> getItemList(String platformType);

	List<SysDictItem> queryItemByDictCode(String promotionDefaultRate);

	List<DictModel> selectItemListByCode(String emailSendRange);
}
