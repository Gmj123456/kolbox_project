package org.jeecg.modules.instagram.storecountry.entity;
...
public class StoreCountry {
     ...
     * 有效标志0=是,1=0
     */
    @Excel(name = "有效标志0=是,1=0", width = 15)
    @Schema(title =  "有效标志0=是,1=0")
