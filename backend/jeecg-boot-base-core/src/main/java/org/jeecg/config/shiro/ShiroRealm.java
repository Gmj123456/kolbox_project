...
public class ShiroRealm extends AuthorizingRealm {
    ...
    public LoginUser checkUserTokenIsEffect(String token) throws AuthenticationException {
        ...
        if (!jwtTokenRefresh(token, username, loginUser.getId(), loginUser.getRealname(), loginUser.getPassword())) {
     ...
     * @return
     */
    public boolean jwtTokenRefresh(String token, String userName, String id, String realname, String passWord) {
