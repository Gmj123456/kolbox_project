...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/sys/wxLogin", "anon"); //登录接口排除
        filterChainDefinitionMap.put("/sys/qqLogin", "anon"); //登录接口排除
        filterChainDefinitionMap.put("/sys/user/checkOnlyUser", "anon");//校验用户是否存在
        filterChainDefinitionMap.put("/sys/user/register", "anon");//用户注册
        filterChainDefinitionMap.put("/sys/user/phoneVerification", "anon");//用户忘记密码验证手机号
        filterChainDefinitionMap.put("/sys/user/passwordChange", "anon");//用户更改密码
        filterChainDefinitionMap.put("/sys/user/wxRegister", "anon");//微信注册
        filterChainDefinitionMap.put("/auth/2step-code", "anon");//登录验证码
        filterChainDefinitionMap.put("/sys/common/static/**", "anon");//图片预览 &下载文件不限制token
        filterChainDefinitionMap.put("/sys/common/pdf/**", "anon");//pdf预览
        filterChainDefinitionMap.put("/sys/user/userPasswordChange", "anon");//用户更改密码
        filterChainDefinitionMap.put("sys/user/querySysUser", "anon");//校验用户是否存在
        ...
        filterChainDefinitionMap.put("/instagram/storeCelebrity/**", "anon");//网红信息添加
        filterChainDefinitionMap.put("/storesellergoods/storeSellerGoods/appGoodsList", "anon");//商品内推列表
        filterChainDefinitionMap.put("/sys/getEmailCode", "anon");//获取邮箱验证码
        filterChainDefinitionMap.put("/notify/**", "anon");//支付回调
        filterChainDefinitionMap.put("/instagram/storeCelebrity/showList", "anon");//宣传页列表
        filterChainDefinitionMap.put("/emailaccount/emailaccount/gmailOauth", "anon");//宣传页列表
        filterChainDefinitionMap.put("/sys/common/upload", "anon");//上传接口
        filterChainDefinitionMap.put("/instagram/messagepushdetail/img", "anon");//邮件打开率
        filterChainDefinitionMap.put("/accessManagement/img", "anon");//二维码连接
        filterChainDefinitionMap.put("/storecustomermessage/storeCustomerMessage/add", "anon");//客户信息表-添加
        filterChainDefinitionMap.put("/storecelebritytrial/storeCelebrityTrial/staticList", "anon");//静态网红首页
        filterChainDefinitionMap.put("/ytnoemail/getList", "anon");//获取无邮箱数据
        filterChainDefinitionMap.put("/ytnoemail/updateKolDataById", "anon");//修改无邮箱数据
        filterChainDefinitionMap.put("/wxPush/weChatCallback", "anon");//微信回调
        filterChainDefinitionMap.put("/storeasinpricetask/storeAsinPriceTask/getLargeScreenList", "anon");//价格大屏接口
        filterChainDefinitionMap.put("/forexrates/list", "anon");//实时汇率
        filterChainDefinitionMap.put("/storecurrencytype/storeCurrencyType/list", "anon");//货币类型
        filterChainDefinitionMap.put("/commodityservicefee/list", "anon");//商品服务费
        filterChainDefinitionMap.put("/storecountry/storeCountry/getCountryList", "anon");// 推广国家
        filterChainDefinitionMap.put("/sys/dictItem/queryValueByDictCode", "anon");// 获取插件使用用户
        filterChainDefinitionMap.put("/instagram/storeCelebrity/addArray", "anon");// 新增tk用户
        filterChainDefinitionMap.put("/storeTiktokWeeklyRank/addArray", "anon");// 新增tk用户
        filterChainDefinitionMap.put("/cmsproduct/listAll", "anon");// cms商品列表
        filterChainDefinitionMap.put("/cmsproduct/queryById", "anon");// cms商品列表
        filterChainDefinitionMap.put("/sys/dict/getDictItems/attributes1_text", "anon");// cms商品列表
        filterChainDefinitionMap.put("/sys/dict/getDictItems/material_text", "anon");// cms商品列表
        filterChainDefinitionMap.put("/promotionalArticle/list", "anon");// 海玛media资讯模块分页列表
        filterChainDefinitionMap.put("/promotionalArticle/listAll", "anon");// 海玛media资讯模块列表
        filterChainDefinitionMap.put("/employeeSecurity/checkEmployee", "anon");// 校验员工
        filterChainDefinitionMap.put("/wxRemind/updateDate", "anon");// 校验员工
        filterChainDefinitionMap.put("/storeCelebrityPrivate/storeCelebrityPrivate/createCelebritySheet", "anon");// 创建私有网红模板
        filterChainDefinitionMap.put("/promotion/request/add", "anon");// KOLBOX官网提交需求
