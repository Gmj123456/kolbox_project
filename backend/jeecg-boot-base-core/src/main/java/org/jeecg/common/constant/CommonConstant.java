 ...
 String CACHE_REL_FIELD_OLD_VAL = "sys:cache:desform:relFieldOldVal:";
   ...
   */
   ...
   Integer PHONE_SMS_FAIL_CODE = 40002;
     ...
     * 授权成功
     */
    public static final String AMAZOM_AUTH_SUCCES = "1";

    /**
     * 授权异常
     */
    public static final String AMAZOM_AUTH_ERROR = "-1";

    /**
     * 授权店铺已存在
     */
    public static final String AMAZOM_AUTH_EXIT = "-2";


    /**
     * 意向金
     */
    public static final Integer PROMOTION_INTENTION_TYPE = 1;
    /**
     * 仅全款
     */
    public static final Integer PROMOTION_FULL_PAYMENT_TYPE = 2;
    /**
     * 意向金/全款单数
     */
    public static final Integer PROMOTION_INTENTION_AND_FULL_PAYMENT_TYPE = 3;

    /**
     * 退款
     */
    public static final Integer PROMOTION_REFUND_TYPE = 5;
    /**
     * 超期
     */
    public static final Integer PROMOTION_EXCEED_TIME_TYPE = 6;


    /**
     * 线上支付
     */
    public static final Integer PAY_ON_LINE = 0;

    /**
     * 线下支付
     */
    public static final Integer PAY_OFF_LINE = 1;

    /**
     * 已开票
     */
    public static final Integer INVOICE_DONE = 1;


    /**
     * 开票已申请
     */
    public static final Integer INVOICE_APPLIED = 0;


    /**
     * 开票已邮寄
     */
    public static final Integer INVOICE_MAIL = 2;

    /**
     * 开票支付类型
     */
    public static final String PAY_TYPE_INVOICE = "20";

    /**
     * 推广支付类型
     */
    public static final String PAY_TYPE_PROMOTION = "10";

    /**
     * 意向金支付类型
     */
    public static final String PAY_TYPE_INTENTION = "11";
    ...
    public static final Integer SC_OK_10001 = 10001;
    /**
     * 状态(0无效1有效)
     */
    ...
    public static final String OTHER_FILE_EXTENSION = "other_file_extension";
    public static final String GENERATE_THUMBNAIL_URL = "url";
    public static final String FILE_PNG = "file.png";
    /**
     * 素材默认类目
     */
    public static final String OBS_CATEGORY_DEFAULT_VALUE = "obs_category_default_value";
    public static final String CATEGORY_DEFAULT_VALUE = "category_default_value";
    public static final String OBS_FILE_TYPE_VALUE = "obs_file_type_value";
    /**
     * paypal code
     */

    public static final String PAYPAL_CODE = "US";
    public static final String ALL_CELEBRITY_PRICE = "allCelebrityPrice";
    public static final String ALL_TAX_AMOUNT = "allTaxAmount";
    public static final String ALL_CELEBRITY_PAYPAL_FEES = "allCelebrityPaypalFees";
    public static final String ALL_CELEBRITY_PROM_PRICE = "allCelebrityPromPrice";
    /**
     * 默认汇率
     */
    public static final String PROMOTION_DEFAULT_RATE = "promotion_default_rate";
    public static final String PROMOTION_DEFAULT_TAX_RATE = "promotion_default_tax_rate";


    public static final String PROMOTION_GOODS_LIST_NEW = "promotionGoodsListNew";
    public static final String TOTAL_AMOUNT_NEW = "totalAmountNew";
     ...
     * Tiktok标签状态
     */
    public static final int TAG_STATUS_FINISH = 99;
    public static final int TAG_STATUS_UN_STARTED = 0;
    public static final int TAG_STATUS_RUNNING = 10;

    public static final String ALLOT_DAYS = "allot_days";
    public static final String RESULT_COUNT = "result_count";

    // 私有网红段位
    public static final String CELEBRITY_SEGMENT = "celebrity_segment";
    //标签是否是活跃标签
    public static final int IS_INACTIVE=0;
    public static final int IS_ACTIVE=1;

    // 分配标签状态
    public static final int KOL_ALOT_LOG_STATUS_FAIL=-1;
    public static final int KOL_ALOT_LOG_STATUS_RUNNIN=1;
    public static final int KOL_ALOT_LOG_STATUS_FINISH=9;
    public static final String[] ignoreProperties = {"id", "remark", "createBy", "createTime", "updateBy", "updateTime"};
