...
import static org.jeecg.common.constant.SystemConstants.SPLIT_CHAR_COMMA;
...
public class CommonUtils {
    ...
    public static List<String> split2List(String str) {
        List<String> result = split2List(str, SPLIT_CHAR_COMMA);
        return result;
    }
    ...
    public static List<String> split2List(String str, String splitChar) {
        List<String> result = Arrays.asList(str.split(splitChar));
        return result;
    }
