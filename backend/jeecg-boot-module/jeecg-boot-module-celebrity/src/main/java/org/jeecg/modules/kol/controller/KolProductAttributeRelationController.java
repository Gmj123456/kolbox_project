...
@RestController
@RequestMapping("/kol/productAttributeRelation")
public class KolProductAttributeRelationController extends JeecgController<KolProductAttributeRelation, IKolProductAttributeRelationService> {
    @Autowired
    ...
    public Result<?> queryPageList(KolProductAttributeRelation productAttributeRelation,
        ...
        QueryWrapper<KolProductAttributeRelation> queryWrapper = QueryGenerator.initQueryWrapper(productAttributeRelation, req.getParameterMap());
        Page<KolProductAttributeRelation> page = new Page<KolProductAttributeRelation>(pageNo, pageSize);
        IPage<KolProductAttributeRelation> pageList = productAttributeRelationService.page(page, queryWrapper);
    ...
    public Result<?> add(@RequestBody KolProductAttributeRelation productAttributeRelation) {
        productAttributeRelationService.save(productAttributeRelation);
    ...
    public Result<?> edit(@RequestBody KolProductAttributeRelation productAttributeRelation) {
        productAttributeRelationService.updateById(productAttributeRelation);
    ...
    public Result<?> delete(@RequestParam(name = "id", required = true) String id) {
        productAttributeRelationService.removeById(id);
    ...
    public Result<?> deleteBatch(@RequestParam(name = "ids", required = true) String ids) {
        this.productAttributeRelationService.removeByIds(Arrays.asList(ids.split(",")));
    ...
    public Result<?> queryById(@RequestParam(name = "id", required = true) String id) {
        KolProductAttributeRelation productAttributeRelation = productAttributeRelationService.getById(id);
        return Result.ok(productAttributeRelation);
    }
    ...
    public ModelAndView exportXls(HttpServletRequest request, KolProductAttributeRelation productAttributeRelation) {
        return super.exportXls(request, productAttributeRelation, KolProductAttributeRelation.class, "产品与标签分类类目关联表");
    }
    ...
    public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
        return super.importExcel(request, response, KolProductAttributeRelation.class);
    }
