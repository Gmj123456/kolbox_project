 ...
 * @Version: V1.0
 */
public interface KolTagCategoryMapper extends BaseMapper<KolTagCategory> {
	 ...
	 * @return 类目路径列表
	 */
	List<KolTagCategory> findCategoryWithSubNodes(@Param("categoryId") String categoryId);
