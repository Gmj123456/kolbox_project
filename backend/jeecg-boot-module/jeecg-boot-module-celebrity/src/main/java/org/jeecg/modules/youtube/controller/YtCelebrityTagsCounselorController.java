...
/**
* @Description: Youtube标签网红顾问分配明细表
* @Author: xyc
* @Date:   2024-12-26 19:41:24
* @Version: V1.0
*/
@Slf4j
@Tag(name="youtube标签网红顾问分配明细表")
@RestController
@RequestMapping("/youtube/ytTagsCounselor")
public class YtCelebrityTagsCounselorController extends JeecgController<YoutubeCelebrityTagsCounselor, IYtCelebrityTagsCounselorService> {
	@Autowired
    ...
    * @return
    */
   @AutoLog(value = "youtube标签网红顾问表-"+ SystemConstants.PAGE_LIST_QUERY)
   @Operation(summary ="youtube标签网红顾问表-"+ SystemConstants.PAGE_LIST_QUERY, description = "youtube标签网红顾问表-"+ SystemConstants.PAGE_LIST_QUERY)
   ...
   public Result<?> queryPageList(@RequestBody KolSearchModel searchModel,
       ...
       IPage<KolTagAllotModel> pageList = ytCelebrityTagsCounselorService.getTagAllottedList(page, searchModel);
